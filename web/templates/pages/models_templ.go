			...
			for _, agent := range agents {
				...
				if agent.IsOAuth() {
					...
					if !agent.HasValidOAuthToken() {
						...
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 77, "\" class=\"btn btn-xs btn-outline\" onclick=\"event.stopPropagation(); return launchOAuthInSystemBrowser(this.dataset.oauthPath, this)\">Connect with OAuth</a>")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					} else {
						...
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 80, "\" class=\"btn btn-xs btn-ghost\" onclick=\"event.stopPropagation(); return launchOAuthInSystemBrowser(this.dataset.oauthPath, this)\">Re-authorize</a>")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					}
