...
func modelsContent(agents []models.LLMConfig, modelWorkerStats map[string]int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			for _, agent := range agents {
				...
				if agent.IsOAuth() {
					...
					if !agent.HasValidOAuthToken() {
						...
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 77, "\" class=\"btn btn-xs btn-outline\" onclick=\"event.stopPropagation(); return launchOAuthInSystemBrowser(this.dataset.oauthPath)\">Connect with OAuth</a>")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					} else {
						...
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 80, "\" class=\"btn btn-xs btn-ghost\" onclick=\"event.stopPropagation(); return launchOAuthInSystemBrowser(this.dataset.oauthPath)\">Re-authorize</a>")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
					}
				...
				if agent.MaxWorkers > 0 {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 82, "<div class=\"mt-2 flex items-center gap-2\"><span class=\"text-sm opacity-60\">Workers:</span> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					...
					if agent.WorkerTimeout > 0 {
						templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 86, "<span class=\"text-xs opacity-50\">")
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 91, "<!-- Reassign Default Modal --><dialog id=\"reassign_default_modal\" class=\"modal\" onclose=\"if (typeof syncToastContainerHost === 'function') syncToastContainerHost()\"><div class=\"modal-box\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
