...
var AllAgentTools = []string{
	...
	"memory_view",
	"send_message",
	"create_alert", "list_alerts", "get_alert", "claim_alert", "create_alert_implementation_task", "link_alert_implementation_task", "complete_alert_processing", "fail_alert_processing", "release_alert_claim",
