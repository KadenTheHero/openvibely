...
func TestCurrentAutomationTemplateRevisionTracksMaintainedTemplateChanges(t *testing.T) {
	require.Equal(t, 7, CurrentAutomationTemplateRevision(AutomationAdapterNativeSDLC))
	require.Equal(t, 5, CurrentAutomationTemplateRevision(AutomationAdapterGitHubSDLC))
