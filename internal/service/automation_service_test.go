...
func TestCurrentAutomationTemplateRevisionTracksMaintainedTemplateChanges(t *testing.T) {
	require.Equal(t, 8, CurrentAutomationTemplateRevision(AutomationAdapterNativeSDLC))
	require.Equal(t, 6, CurrentAutomationTemplateRevision(AutomationAdapterGitHubSDLC))
