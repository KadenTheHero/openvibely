...
GitHub actions remain constrained by configured project/integration readiness and the supported lifecycle topology. Publication creates only configured producer/inbox Tasks and Scheduler rows. Issues, issue-specific Tasks, and pull requests arise later through existing GitHub and Task services.
