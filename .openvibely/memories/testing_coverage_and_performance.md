...
- CI optimization opportunity tracked in `openvibely/openvibely#26`: the GitHub Actions Linux desktop dependency installation consumed 20–40 seconds across 10 measured runs, with a 27.5-second median representing 16.7% of median workflow duration. The issue proposes caching or pre-baking those dependencies and validating both warm and cold-cache runs against the baseline.
