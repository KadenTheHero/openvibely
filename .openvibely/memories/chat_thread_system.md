...
Swarm task facts:
- Swarm tasks are a parent/child task orchestration mode with planner, worker, reviewer, and integrator children plus parent summaries, task-detail swarm panels, and a `create_swarm_task` runtime tool.
