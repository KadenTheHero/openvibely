...
- Recurring audit-methodology lesson: under strict “audit finds one issue, stop and fix separately” on large active features, expect several rounds where each fresh full-scope audit finds one adjacent or analogous bug before a clean audit is reached.
