...
- [OpenVibely Update System](openvibely_update_system.md) - Signed update architecture, distribution-specific apply/recovery contracts, durable drain/admission rules, completed fixes, validation, and clean final audit status.
