...
source_id: b300a40908e1f0b835d6ead0aa77fd99:10a752d1d304c742
confidence: high
...
- `extras.execution_error` is outcome metadata and is always delivered to after-complete hooks on failed task runs even when omitted from the hook's declared payload. Its absence on successful runs remains meaningful.
