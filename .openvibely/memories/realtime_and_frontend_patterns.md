...
source_id: c17cffafa52766014caf85849acc98c6
confidence: high
...
- Live Chat completion reconciliation targets the inner assistant stream node identified by `streaming-message-<exec_id>`, not the outer turn/execution wrapper with `data-exec-id`, so completed output stays inside the assistant bubble and refresh/live markup remain equivalent.
