...
- Startup sync uses `git status --porcelain` dirty guard, logs explicit ran/skipped/failed outcomes, and aborts merge conflicts while marking `merge_status=conflict`.
