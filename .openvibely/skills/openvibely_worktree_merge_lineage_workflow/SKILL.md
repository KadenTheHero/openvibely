...
5. Add a targeted test: given project repo path `/repo/main` and task worktree `/repo/main/.worktrees/task_x`, an implementation task prompt must not contain `/repo/main` as `## Repository`; it must contain `/repo/main/.worktrees/task_x`.
