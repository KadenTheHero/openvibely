...
warn "=============================="
warn "Docker image tagging and publishing requires Docker Hub accounts with"
warn "write access to openvibely/openvibely and openvibely/openvibely-agent."
warn ""
warn "To publish the production and coding-agent images, run on your Docker-authenticated host:"
warn ""
...
info "      --push ."
warn ""
info "  docker buildx build --platform linux/amd64,linux/arm64 -f Dockerfile-ext \\"
info "      -t openvibely/openvibely-agent:${VERSION} \\"
info "      -t openvibely/openvibely-agent:latest \\"
info "      --push ."
warn ""
