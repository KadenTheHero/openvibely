...
info "Tag:       v${VERSION}"
echo ""
warn "REMINDER: Publish production and coding-agent Docker images manually if applicable:"
...
info "      -t openvibely/openvibely-agent:${VERSION} -t openvibely/openvibely-agent:latest --push ."
