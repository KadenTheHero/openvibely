...
- `OPENVIBELY_ENABLE_TASK_CHANGES_MERGE_OPTIONS` gates the Task Changes tab merge-option UI; when disabled by default, merge-option controls are hidden and server-side requests using disabled options should be rejected with `403`.
